<form wire:submit.prevent="creatpost" class="pt-4 pb-3 mb-3 border-0 card w-100 shadow-xss rounded-xxl ps-4 pe-4">
    ...
    <div class="p-0 mt-3 card-body position-relative">
        <figure class="mt-1 avatar position-absolute ms-2 top-5"><img src="{{ auth()->user()->profile ? auth()->user()->profile : 'images/user-8.png' }}" alt="image" class="shadow-sm rounded-circle w30"></figure>
